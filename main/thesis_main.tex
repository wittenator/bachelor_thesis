...
%
\hypersetup{
	pdftitle={Comparing interpretability techniques for unsupervised topic extraction},  % please, add the title of your thesis
...
\input{../chapters/abstract/abstract_en}
\input{../chapters/abstract/abstract_de} 
...
\input{../chapters/literature_analysis/literature_analysis}
...
\bibliography{../references/thesis/main.bib}
